...
namespace Invicta.Numerics
{
    public static unsafe partial class Vector
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float GetElement(this Vector4D vector, int index) => vector.AsVector128().GetElement(index);

        /// <summary>Stores a vector at the given destination.</summary>
        /// <param name="source">The vector that will be stored.</param>
        /// <param name="destination">The destination at which <paramref name="source" /> will be stored.</param>
        [CLSCompliant(false)]
        public static void Store(this Vector4D source, float* destination) => source.AsVector128().Store(destination);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void StoreAligned(this Vector4D source, float* destination) => source.AsVector128().StoreAligned(destination);
        ...
        [CLSCompliant(false)]
        public static void StoreAlignedNonTemporal(this Vector4D source, float* destination) => source.AsVector128().StoreAlignedNonTemporal(destination);

        /// <summary>Stores a vector at the given destination.</summary>
        /// <param name="source">The vector that will be stored.</param>
        /// <param name="destination">The destination at which <paramref name="source" /> will be stored.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void StoreUnsafe(this Vector4D source, ref float destination) => source.AsVector128().StoreUnsafe(ref destination);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void StoreUnsafe(this Vector4D source, ref float destination, nuint elementOffset) => source.AsVector128().StoreUnsafe(ref destination, elementOffset);

        /// <inheritdoc cref="Vector128.ToScalar{T}(Vector128{T})" />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float ToScalar(this Vector4D vector) => vector.AsVector128().ToScalar();
